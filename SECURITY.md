...
Instead, please report them via email to: **security@ez.agents** (or DM @glittercowboy on Discord/Twitter if email bounces)
...
Security issues in the EZ Agents codebase that could:
